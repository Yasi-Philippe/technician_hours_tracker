...
const it = {
  ...
  extraShort: 'extra',
  overtimeAuto: 'Le ore extra si calcolano da sole',
  overtimeManual: 'Ore extra a mano',
  adjustOvertime: 'Correggi le ore extra',
  useAutomatic: 'Torna al calcolo automatico',
...
const es: Strings = {
  ...
  extraShort: 'extra',
  overtimeAuto: 'Las horas extra se calculan solas',
  overtimeManual: 'Horas extra a mano',
  adjustOvertime: 'Corregir las horas extra',
  useAutomatic: 'Volver al cálculo automático',
