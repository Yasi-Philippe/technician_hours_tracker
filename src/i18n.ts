...
const it = {
  ...
  // Stats
  rangeYear: 'Anno',
  statsHours: 'ore lavorate',
  vsPrevious: 'rispetto al periodo prima',
  noPrevious: 'nessun confronto',
  longestDay: 'Giornata più lunga',
  showNumbers: 'Mostra i numeri',
...
const es: Strings = {
  ...
  noPrevious: 'sin comparación',
  longestDay: 'Jornada más larga',
